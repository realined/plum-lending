...
Live evidence: actual Gmail OAuth and HubSpot authentication, approved account identities, separate writer consent, seed creation/replay and two reader jobs have passed. The live worker scanned 7 CRM contacts and returned the exact 2 contacts, 2 threads and 5 messages in 6.862/7.402 seconds. Full-thread UI inspection and the downloaded eight-column CSV passed. These jobs used a reviewed typed specification directly; real-model interpretation and the complete natural-language journey remain pending.
